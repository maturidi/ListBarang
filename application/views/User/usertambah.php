                    ...
                    <div class="panel panel-info">
                        ...
                        <!-- /.panel-heading -->
                         ...
                         <div class="panel-body">
                            <form action="<?php echo base_url(); ?>Cuser/store" method="POST">
								<div class="form-group">
									<label>ID User</label>
									<input type="number" readonly value="<?php echo set_value('id'); ?>" class="form-control" name="id" placeholder="ID User"></input>
									<?php echo form_error('id', '<p style="color: #a94442">', '</p>'); ?>
								</div>
								<div class="form-group">
									<label>Nama User</label>
									<input type="text" value="<?php echo set_value('nama'); ?>" class="form-control" name="nama" placeholder="Nama User"></input>
								...
								<div class="form-group">
									...
									<input type="password" value="<?php echo set_value('password'); ?>" class="form-control" name="password" placeholder="Password"></input>
