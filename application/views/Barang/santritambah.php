                    ...
                    <div class="panel panel-info">
                        ...
                        <!-- /.panel-heading -->
                         ...
                         <div class="panel-body">
                            <form action="<?php echo base_url(); ?>csantri/store" method="POST">
								<div class="form-group">
									<label>NIS</label>
									<input type="number" value="<?php echo set_value('nis'); ?>" class="form-control" name="nis" placeholder="NIS"></input>
								...
								<div class="form-group">
									...
									<select name="asrama" class="form-control">
										...
										foreach($asrama->result() as $row) {
											if ($row->IDAsrama == set_value('asrama')) {
												echo '<option value="'. $row->IDAsrama .'" selected>'. ucwords($row->NamaAsrama) .'</option>';
											} else {
												echo '<option value="'. $row->IDAsrama .'">'. ucwords($row->NamaAsrama) .'</option>';
											}
										}
										?>
								...
								<div class="form-group">
									...
									<input type="number" value="<?php echo set_value('total'); ?>" class="form-control" name="total" placeholder="Total Buku Yang Diterima"></input>
